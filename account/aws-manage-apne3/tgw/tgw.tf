...
## ============================================================================
## VPC Attachment - manage-apne3
## ============================================================================
resource "aws_ec2_transit_gateway_vpc_attachment" "manage_apne3" {
  transit_gateway_id = aws_ec2_transit_gateway.main.id
  vpc_id             = local.manage_apne3.vpc_id
  subnet_ids         = local.manage_apne3.subnet_ids
  ...
  tags = {
    Name        = "${local.project_code}-${local.account}-${local.aws_region_code}-tgw-attach-manage-apne3"
    auto-delete = "no"
  }
}

## ============================================================================
## VPC Attachment - dev-apne3 (from dev account via RAM share)
## ============================================================================
resource "aws_ec2_transit_gateway_vpc_attachment" "dev_apne3" {
  provider = aws.dev-apne3

  transit_gateway_id = aws_ec2_transit_gateway.main.id
  vpc_id             = local.dev_apne3.vpc_id
  subnet_ids         = local.dev_apne3.subnet_ids
  ...
  tags = {
    Name        = "${local.project_code}-${local.account}-${local.aws_region_code}-tgw-attach-dev-apne3"
    auto-delete = "no"
  }
}

## ============================================================================
## VPC Routes - manage-apne3 to dev-apne3 (same region)
## ============================================================================
resource "aws_route" "manage_apne3_private_to_dev_apne3" {
  for_each = toset(local.manage_apne3.private_route_table_ids)

  route_table_id         = each.value
  destination_cidr_block = "10.30.0.0/16" # dev-apne3 VPC
  transit_gateway_id     = aws_ec2_transit_gateway.main.id

  depends_on = [
    aws_ec2_transit_gateway_vpc_attachment.manage_apne3,
    aws_ec2_transit_gateway_vpc_attachment.dev_apne3
  ]
}

resource "aws_route" "manage_apne3_public_to_dev_apne3" {
...
## ============================================================================
## VPC Routes - dev-apne3 to manage-apne3 (same region)
## ============================================================================
resource "aws_route" "dev_apne3_private_to_manage_apne3" {
  provider = aws.dev-apne3
  for_each = toset(local.dev_apne3.private_route_table_ids)

  route_table_id         = each.value
  destination_cidr_block = "10.3.0.0/16" # manage-apne3 VPC
  transit_gateway_id     = aws_ec2_transit_gateway.main.id
...
resource "aws_route" "dev_apne3_public_to_manage_apne3" {
  provider = aws.dev-apne3
